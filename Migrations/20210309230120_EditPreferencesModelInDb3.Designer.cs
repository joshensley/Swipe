...
namespace Swipe.Migrations
{
    ...
    [Migration("20210309230120_EditPreferencesModelInDb3")]
    partial class EditPreferencesModelInDb3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Swipe.Models.Admin.Height", b =>
                {
                    ...
                    b.Property<string>("HeightInInches")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Swipe.Models.Admin.Gender", b =>
                {
                    b.HasOne("Swipe.Areas.User.Models.Preferences", null)
                        .WithMany("Genders")
                        .HasForeignKey("PreferencesID");
                });
